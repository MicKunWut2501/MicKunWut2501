  ...
  return (
    <header className="border-b border-gray-200 bg-white">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-6 gap-y-2 px-4 py-3">
        <Link href="/painel" className="text-base font-semibold tracking-tight">Frota Luanda</Link>
        ...
        <form action={signOut} className="ml-auto flex items-center gap-3 text-sm text-gray-600">
          ...
          <button className="rounded-md border border-gray-300 px-2 py-1 text-xs hover:bg-gray-50">Sair</button>
        </form>
      </div>
    </header>
  );
